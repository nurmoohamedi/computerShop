      ...
      <Container>
        <Grid container className={styles.footer_top}>
          <Grid item xs={12} sm={9} md={5} className={styles.footer_logo}>
            ...
            <Box className={styles.footer_text}>
              Computech – it has never been easier to buy cheap computers, and
              ordering household appliances, electronics and telecommunications
              equipment has never been as convenient as in the "computech"
              online store.
            </Box>
            <Box className={styles.footer_media}>
              <a href="https://facebook.com/muhamedi21" target="_blank">
                <Facebook />
              </a>
              <a href="https://twitter.com" target="_blank">
                <Twitter />
              </a>
              <a href="https://web.telegram.org/k/#@muhamedl21" target="_blank">
                <Telegram />
              </a>
              <a href="https://www.instagram.com/muhamedi21/" target="_blank">
                <Instagram />
              </a>
        ...
        <Box className={styles.footer_bottom}>
          ...
          <p>
            Designed By{" "}
            <a
              href="https://www.instagram.com/muhamedi21/"
              target="_blank"
